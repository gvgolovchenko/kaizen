...
|----------|-----|----------|
| Главная (Dashboard) | `/` | Обзор системы — 8+ виджетов, аналитика, лента активности |
| Продукты | `/products.html` | Список продуктов — карточки с сортировкой |
...
| Миграция БД (001–019) | Готово |
| Backend API (65+ эндпоинтов) | Готово |
| Frontend (8 страниц) | Готово |
...
| MCP-сервер (38 инструментов) | Готово |
...
| Smoke-тесты (Playwright) | Готово |
| GitLab Issues интеграция | Готово |
| Документация | Готово |
